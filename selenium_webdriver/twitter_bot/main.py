...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        time.sleep(3)
        button_start = self.driver.find_element_by_xpath('//*[@id="container"]/div/div[3]/div/'
                                                         'div/div/div[2]/div[3]/div[1]/a')
        button_start.click()

        time.sleep(40)
        self.down = self.driver.find_element_by_xpath('//*[@id="container"]/div/div[3]/div/div/div/'
                                                    'div[2]/div[3]/div[3]/div/div[3]/div/div/div[2]/'
                                                    'div[1]/div[2]/div/div[2]/span').text
        print(self.down)
        self.up = self.driver.find_element_by_xpath('//*[@id="container"]/div/div[3]/div/'
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(2)
        email = self.driver.find_element_by_xpath('//*[@id="react-root"]/div/div/div[2]/main/div/div/'
                                                  'div[1]/form/div/div[1]/label/div/div[2]/div/input')
        password = self.driver.find_element_by_xpath('//*[@id="react-root"]/div/div/div[2]/main/div/div/'
        ...
        tweet_compose = self.driver.find_element_by_xpath(
            ...
            'div[1]/div/div/div/div[2]/div[1]/div/div/div/div/div/div/div/div/div/div[1]/'
